...
// Debug mode - set to true to show collision zones
const DEBUG = false;
...
// Joystick functionality is now in joystick.js
// joystickState, initJoystick(), resetJoystick(), and setupJoystickEvents() are accessible globally from that file
...
function drawGame() {
    ...
    // Use common rendering function (collision zones shown only in debug mode)
    drawGameScene(ctx, canvas, gameState, images, DEBUG);
}
